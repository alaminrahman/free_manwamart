                                ...
                                @foreach ($attributes as $attribute)
                                    <div class="bg-white shadow-sm rounded mb-3">
                                        ...
                                        <div class="p-3">
                                            ...
                                            <select name="selected_attribute_values[]" id="">
                        ...
                        <div class="text-left">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="form-group ml-auto mr-0 w-200px d-none d-xl-block">
                                    <label class="mb-0 opacity-50">{{ translate('Product Per Page')}}</label>
                                    <select class="form-control form-control-sm aiz-selectpicker" name="ppp" onchange="filter()">
