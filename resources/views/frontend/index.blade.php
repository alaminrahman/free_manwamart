...
<div class="items">
@php
$fbreviews = DB::table('fbreviews')->inRandomOrder()->take(10)->get();
@endphp
@foreach($fbreviews as $fbreview)
    <div class="card">
        <div class="card-body">
            <h4 class="card-title"><img src="https://img.icons8.com/ultraviolet/40/000000/quote-left.png"><p>{{Str::limit($fbreview->review_text, 100, $end='....')}}</p></h4>
            <hr>
            <div class="row">
                <div class="col-sm-2"> <img class="profile-pic" src="{{$fbreview->user_pic}}"> </div>
                <div class="col-sm-10">
                    <div class="profile">
                        <h4 class="cust-name">{{$fbreview->reviewer_name}}</h4>
