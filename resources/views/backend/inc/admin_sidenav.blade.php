            ...
            <!-- Sale -->
                <li class="aiz-side-nav-item">
                    ...
                    <ul class="aiz-side-nav-list level-2">
                        ...
                        <li class="aiz-side-nav-item">
                            <a href="{{ route('courier.index') }}" class="aiz-side-nav-link {{ areActiveRoutes(['courier.index'])}}">
                                <span class="aiz-side-nav-text">{{translate('Courier')}}</span>
                            </a>
                        </li>
                    @endif
                    @if(Auth::user()->user_type == 'admin' || in_array('8', json_decode(Auth::user()->staff->role->permissions)))
                        <li class="aiz-side-nav-item">
                            <a href="{{ route('courier.assignment_index') }}" class="aiz-side-nav-link {{ areActiveRoutes(['courier.assignment_index'])}}">
