...
Route::group(['prefix' => 'admin', 'middleware' => ['auth', 'admin']], function() {
    ...
    //courier crud
    Route::post('/courier/store', 'OrderController@courierStore')->name('courier.store');
    Route::get('/courier', 'OrderController@courier_index')->name('courier.index');
    Route::get('/delete/{id}','OrderController@courierdDelete')->name('courier.delete');

    //assignment courier
    Route::get('/courier-assignment', 'OrderController@courier_assignment_index')->name('courier.assignment_index');
